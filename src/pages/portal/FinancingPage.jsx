  ...
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="bg-white/90 backdrop-blur-sm p-8 rounded-lg shadow-lg mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-700">Click the banner below or visit snapfinance.com</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-700">Receive a decision in minutes, up to $5,000</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-700">Bring your vehicle in for the repairs you need</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-700">Make affordable payments that fit your budget</p>
            </div>
          </div>
        </div>

        {/* Apply Now Section */}
        <div className="bg-gradient-to-r from-gray-800/80 to-gray-900/80 backdrop-blur-sm p-8 rounded-lg shadow-xl text-center">
        ...
        {/* FAQ Section */}
        <div className="mt-12 bg-white/90 backdrop-blur-sm p-8 rounded-lg shadow-lg">
